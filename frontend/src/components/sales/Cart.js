    ...
    return ( 
        <div className='w-7/12 h-[620px] ml-12 grow p-6 rounded-xl shadow-xl border border-solid border-neutral-300 flex'>
            ...
            <div className='grow flex flex-col'>
                ...
                <Summary createTransaction={props.createTransaction} setPayment={props.setPayment} loadBon={props.loadBon} saveBon={props.saveBon} user={props.user} pointsAdded={props.pointsAdded} total={props.total} cash={props.cash} change={props.change} setCash={props.setCash} payment={props.payment}/>
            </div>
        </div>
    );
}
